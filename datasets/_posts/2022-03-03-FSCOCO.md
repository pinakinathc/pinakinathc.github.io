...
<!-- <script>location.replace("https://fscoco.github.io/")</script> -->

<!-- [![Sample Comparison FSCOCO dataset](/assets/images/organizations/sketchx-logo.png)](http://sketchx.ai/) -->
<a href="http://sketchx.ai/"><img src="/assets/images/organizations/sketchx-logo.png" style="width:70%; max-width: 300px; border:None;" class='img-fluid img-thumbnail'></a><br/><br/>
...
[Paper](/assets/papers/fscoco.pdf) / [Github](https://github.com/pinakinathc/fscoco)
